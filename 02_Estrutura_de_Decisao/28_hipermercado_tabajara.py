...
Escreva um programa que peça o tipo e a quantidade de carne comprada pelo usuárioe gere um cupom fiscal,
...
print('2 - Alcatra')
print('3 - Picanha')
tipoCarne = str(input('Informe o tipo da carne escolhida: '))

# Escolha da quantidade
qtd = float(input('Informe a quantidade comprada: '))

# Verifica cartao
cartaoTabajara = str(input('Usará cartao Tabajara (S/N): '))
