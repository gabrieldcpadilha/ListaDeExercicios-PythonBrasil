...
# Entrada de dados
morangos = float(input('Informe a quantidade (em Kg) de morangos comprados: '))
macas = float(input('Informe a quantidade (em Kg) de macas comprados: '))
...
if (morangos + macas) >= 8 or valorBruto >= 25:
    valorBruto = valorBruto * 0.9

print(f'Valor a pagar: R${valorBruto:.2f}')
